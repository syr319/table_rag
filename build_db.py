...
def main(dataset_path, embed_model_name='sentence-transformers/all-MiniLM-L6-v2',max_encode_cell = 10000):
    ...
    done_table_ids = set()
    # retriever = Retriever(agent_type='TableRAG',mode='embed', embed_model_name='text-embedding-3-large', top_k=5, max_encode_cell=max_encode_cell, db_dir=db_dir)
    retriever = Retriever(agent_type='TableRAG', mode='embed', embed_model_name=embed_model_name, top_k=5, max_encode_cell=max_encode_cell, db_dir=db_dir)
