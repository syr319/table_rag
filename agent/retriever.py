...
class Retriever:
    def __init__(self, agent_type, mode, embed_model_name, top_k = 5, max_encode_cell = 10000, db_dir = 'db/', verbose = False):
        ...
        if self.mode == 'bm25':
            ...
            local_model_path = "/home/shenyiran/.cache/huggingface/hub/models--sentence-transformers--all-MiniLM-L6-v2"
            self.embedder = HuggingFaceEmbeddings(model_name=local_model_path)
